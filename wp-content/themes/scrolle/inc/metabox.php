...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'desc'		=> __('Section Name. Example : <b> about </b> And this box is alternative Nav class name.',"theme2035"),
			'clone'		=> false,
			'type'		=> 'text',
		),		
		array(
...
$meta_boxes[] = array(
	...
	'fields'	=> array(
		array(
			'name'	=> __('Gallery Slider Featured Images','2035Themes-fm'),
			'desc'	=> __('Max Photo Limit is <b>20</b>','2035Themes-fm'),
			'id'	=> $prefix . 'blogslides',
			'type'	=> 'plupload_image',
			'max_file_uploads' => 20,
		)
