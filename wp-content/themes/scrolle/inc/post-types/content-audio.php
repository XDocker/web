...
************************************************************************************************** -->
    ...
    <article <?php post_class('clearfix fitvids'); ?> id="post-<?php the_ID(); ?>">
        <div class="blog-post clearfix">
            <?php  echo get_post_meta( get_the_ID(), 'theme2035_audio', true ) ?> 
            ...
            <div class=" margint20 clearfix">
                <div class="post-type-icon">
                    <div class="post-type-icon-box">
                        <i title="Audio Post Format" class="fa fa-microphone"></i>
                    </div>    
                </div>
                <div class="post-content marginb60">
                <?php  if(is_single()){ ?>
                    <div class="excerpt">
                        <?php the_content(); ?>
                    </div>
