...
************************************************************************************************** -->
    ...
    <div class="blog-post  clearfix">
        <div id="slider-post" class="flexslider">
                ...
                <ul class="slides">
                    <?php foreach( $images as $image ) :  ?>
                        ...
                        <?php } else {
                        ?>
                        <a href="<?php the_permalink(); ?>"><?php echo wp_get_attachment_image($image->ID, 'attachment-standard'); ?></a> 
                        <?php } ?>
                        </li>
                    <?php endforeach; ?>
                </ul>
            ...
            <div class=" margint20 clearfix">
                <div class="post-type-icon">
                    <div class="post-type-icon-box">
                        <i title="Gallery Post Format" class="fa fa-picture-o"></i>
                    </div>    
                </div>
